...
export const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        I&apos;m Awolad Hossain, a full-stack developer based in Bangladesh.
        I&apos;m passionate about building scalable APIs, modern web
        applications, and containerized solutions using technologies like
        Next.js, React, Node.js, Go, and Docker. I enjoy solving complex
        problems and turning ideas into production-ready systems.
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
